...
public class Player {
    ...
    public static void main(String[] args) {
        Player newPlayer1 = new Player("Mario");
        Player newPlayer2 = new Player("Mario", 35);

        System.out.println(newPlayer1.playerName + " - Level " + newPlayer1.level);
        System.out.println(newPlayer2.playerName + " - Level " + newPlayer2.level);
    }
}
